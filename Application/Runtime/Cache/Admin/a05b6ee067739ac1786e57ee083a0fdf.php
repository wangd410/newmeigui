...
<form action="/newmeigui/index.php/Admin/Adtype/update_info" method="post" class="definewidth m20" enctype="multipart/form-data">
    <table style="margin-left:10px;margin-top:3px;text-align:right;">
        ...
        <select id="country" name="na_adtype_country">
            ...
            <option value="巴勒斯坦民族权力机构">巴勒斯坦民族权力机构</option>
            ...
            <option value="法属南极地区">法属南极地区</option>
            ...
            <option value="刚果(DRC)">刚果(DRC)</option>
            ...
            <option value="赫德和麦克唐纳群岛">赫德和麦克唐纳群岛</option>
            ...
            <option value="科科斯群岛(基灵群岛)">科科斯群岛(基灵群岛)</option>
            <option value="科摩罗联盟">科摩罗联盟</option>
            <option value="科特迪瓦共和国">科特迪瓦共和国</option>
            <option value="科威特">科威特</option>
            <option value="克罗地亚">克罗地亚</option>
            <option value="肯尼亚">肯尼亚</option>
            <option value="库可群岛">库可群岛</option>
            ...
            <option value="南乔治亚和南德桑威奇群岛">南乔治亚和南德桑威奇群岛</option>
            ...
            <option value="沙巴岛">沙巴岛</option>
            <option value="沙特阿拉伯">沙特阿拉伯</option>
            <option value="法属圣马丁岛">法属圣马丁岛</option>
            <option value="荷属圣马丁岛">荷属圣马丁岛</option>
            <option value="圣马力诺">圣马力诺</option>
            <option value="圣皮埃尔岛和密克隆岛">圣皮埃尔岛和密克隆岛</option>
            <option value="圣文森特和格林纳丁斯">圣文森特和格林纳丁斯</option>
            <option value="圣尤斯特歇斯岛">圣尤斯特歇斯岛</option>
            ...
            <option value="维尔京群岛(英属)">维尔京群岛(英属)</option>
