...
<form action="/newmeigui/index.php/Admin/ta" method="post" class="definewidth m20" enctype="multipart/form-data">
    <table style="margin-left:10px;margin-top:3px;text-align:right;">
        品牌名称：<input type="text" name="name" placeholder="请输入品牌名称"><br />
        品牌图标：</label> <img id="img" src="<?php echo is_photo($info['na_user_photopath']);?>" />
        <input type="file" id="pic" onchange="up_pic();"/><input type="hidden" id="path" name="" ><br />
        成立时间：<input class="easyui-datebox" name="time" placeholder="请输入成立时间"><br /><br/>
        国&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;家：
        <select name="country">
        ...
        代&nbsp;言&nbsp;&nbsp;人：<input type="text" name="people" placeholder="请输入代言人"><br />
        官方网址：<input type="text" name="address" placeholder="请输入官方网址"><br />
        简&nbsp;&nbsp;介：<textarea name="intro"></textarea><br />
