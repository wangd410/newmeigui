...
<body>
	...
	<div id="head">
		...
		<div class="mainScreen">
				<ul class="grayLine">
					<li>年份：</li>
					<?php $__FOR_START_28075__=$year-16;$__FOR_END_28075__=$year+1;for($i=$__FOR_START_28075__;$i < $__FOR_END_28075__;$i+=1){ ?><li><a href="<?php echo U('AdSearch/index',array('year'=>$i));?>"><?php echo ($i); ?></a></li><?php } ?>
				</ul>
				<ul class="whiteLine">
					<li>品牌：</li>
