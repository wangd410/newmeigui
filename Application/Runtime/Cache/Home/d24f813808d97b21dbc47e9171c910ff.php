        ...
        <div class="home">
            <div class="info">
                <form action="/newmeigui/index.php/Home/Login/res_check" method="post">
                    ...
                    <p>　　用户名<input type="text" class="inp" name="na_user_name_a" id="usernameq_a" ></p><span id="dive"></span>
                    <p>　邮箱地址<input type="text" class="inp" name="na_user_loginName" id="phonqe"></p><span id="divb"></span>
